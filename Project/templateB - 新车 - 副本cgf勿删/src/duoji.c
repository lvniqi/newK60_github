...
void duoji_Control8(void)
{
  ...
  */
  ...
  //duoji_Kp=10000*pow(2,-(((ad7_avg+ad8_avg)/2.0)/180.0-2.0));
  //duoji_Kp=30000/(arg1/arg3);
  //duoji_Kp=30000/arg1;
  duoji_Kp=20000*pow((pow(ad3_avg,2)+pow(ad4_avg,2))/2.0,0.5)/((ad3_avg+ad4_avg)/2);
  duoji_Kd=2*duoji_Kp;
  ...
  */
  if(left_max_f)
  {
    if(ad1_avg>ad2_avg&&ad3_avg>ad4_avg&&ad8_avg>100||left==false)
    {
      left_max_f=false;
      //beep_time=10;
    }
  ...
  {
    if(ad2_avg>ad1_avg&&ad4_avg+ad3_avg&&ad8_avg>100||right==false)
    {
      right_max_f=false;
      //beep_time=10;
    }
