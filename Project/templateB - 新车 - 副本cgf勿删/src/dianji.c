...
{  
  ...
  {
    //dianji_PTurn(2000); //spexpect=100
    dianji_PID();
    dianji_PTurn(dianji);
  }
}
...
void dianji_PID(void)
{
  ...
  //sp_expect=(u32)(200-ABS((duoji-duoji_mid)/30));
  sp_expect=(u32)(205*(ad7_avg+ad8_avg)/2/(pow((pow(ad7_avg,2)+pow(ad8_avg,2))/2.0,0.5)));
  //sp_expect=150;
  sp_e0=sp_expect-sp;
