...
/*****************************************************************************
 ...
 返 回 值  : NONE
*****************************************************************************/
void OLED_P6x8Char(unsigned char ucIdxX, unsigned char ucIdxY, unsigned char ucData)
{
...
/*****************************************************************************
 ...
 返 回 值  : NONE
*****************************************************************************/
void OLED_P6x8Str(unsigned char ucIdxX, unsigned char ucIdxY, unsigned char ucDataStr[])
{
...
/*****************************************************************************
 ...
 返 回 值  : none
*****************************************************************************/
void OLED_PrintShort(unsigned char ucIdxX, unsigned char ucIdxY, short int sData)
{
...
void PrintParemeter(void)
{
  ...
  get(ad8_avg, duojiTemp, 8, 8, 4);
  //OLED_P6x8Str(0,4,"PrintParemeter");
  
}

void ChangeParemeter(void)
{
  DisableInterrupts();
  //PIT_ITDMAConfig(HW_PIT_CH0, kPIT_IT_TOF, DISABLE); //关闭中断
  
  //writeParemeter();
  changeStatus = true;
  Flash_erase_sector(200);
  MyFlash_write(200, 0, (u32)duoji_Kd_Flash);
...
/*****************************************************************************
 函 数 名  : OLED_CLS_ROW
 功能描述  : 对一列写入同一个字符函数 
             如 OLED_CLS_ROW(0x01);    对于某一位0为不亮 1为亮
            ------------------------------------------------------
                                共128列
                  1           1                1
              共  0           0                0
 ...
 返 回 值  : NONE
*****************************************************************************/
void OLED_CLS_ROW(unsigned char ucPage)
{
