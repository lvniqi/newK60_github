  ...
  #define ANGLE_goto_edge(angle)        {if((angle) > ANGLE_LIMIT_RIGHT-650){(angle) = ANGLE_LIMIT_RIGHT;}\
                                         else if((angle) <ANGLE_LIMIT_LEFT+650){(angle) = ANGLE_LIMIT_LEFT;}}   
