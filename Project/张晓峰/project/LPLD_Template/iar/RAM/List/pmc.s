///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       11/Aug/2014  21:44:52
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\lib\drivers\pmc\pmc.c
//    Command line =  
//        "C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\lib\drivers\pmc\pmc.c" -D
//        IAR -D LPLD_K60 -lCN
...
//        -Ol
//    List file    =  
//        C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\project\LPLD_Template\iar\RAM\List\pmc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   87     SMC_PMCTRL =  SMC_PMCTRL_STOPM(0);           // set LPLLSM = 0b000
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
//   88     stop();
        BL       stop
//   89 }
...
enter_vlpr:
        PUSH     {R4,LR}
        MOVS     R4,R0
//  109      SMC_PMPROT = SMC_PMPROT_AVLP_MASK;  // write oneif not all set make sure all enabled
        MOVS     R0,#+32
        LDR.W    R1,??DataTable13_1  ;; 0x4007e000
        STRB     R0,[R1, #+0]
...
//  119     SIM_CLKDIV1  =  0x03330000;    //(SIM_CLKDIV1_OUTDIV1(1) | SIM_CLKDIV1_OUTDIV2(3) \ 
        LDR.W    R0,??DataTable13_4  ;; 0x3330000
        LDR.W    R1,??DataTable13_5  ;; 0x40048044
        STR      R0,[R1, #+0]
...
//  137     if(lpwui_value){
        ...
        CMP      R4,#+0
        BEQ.N    ??enter_vlpr_0
//  138        SMC_PMCTRL = (SMC_PMCTRL_LPWUI_MASK       // set LPWUI
//  139                     | SMC_PMCTRL_RUNM(2));       // set RUNM = 0b10     
        MOVS     R0,#+192
        LDR.W    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
        B.N      ??enter_vlpr_1
//  140    
//  141      } else {
//  142        SMC_PMCTRL = (!SMC_PMCTRL_LPWUI_MASK            // clear LPWUI
//  143                    | SMC_PMCTRL_RUNM(2));             // set RUNM = 0b10 
??enter_vlpr_0:
        MOVS     R0,#+64
        LDR.W    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
...
//  148 
//  149      while((PMC_REGSC & (SMC_PMSTAT & 0x04))==0);    // 0 MCU is not in VLPR mode
??enter_vlpr_1:
        LDR.W    R0,??DataTable13_10  ;; 0x4007d002
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R1,??DataTable13_11  ;; 0x4007e003
        LDRB     R1,[R1, #+0]
...
//  154               if ((UART_S1_REG(TERM_PORT) & UART_S1_RDRF_MASK)) {
        LDR.W    R0,??DataTable13_13  ;; 0x400eb004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??enter_vlpr_3
//  155                  break;
...
exit_vlpr:
        PUSH     {R7,LR}
//  175     /* Clear RUNM */
//  176     SMC_PMCTRL &= ~(SMC_PMCTRL_RUNM(0x3));
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        ANDS     R0,R0,#0x9F
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
//  177                    
//  178     /* Wait for normal RUN regulation mode to be confirmed */                   
//  179     while (PMC_REGSC & (SMC_PMSTAT & 0x04)); // 0 MCU is not in VLPR mode
??exit_vlpr_0:
        LDR.W    R0,??DataTable13_10  ;; 0x4007d002
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.N    R1,??DataTable13_11  ;; 0x4007e003
        LDRB     R1,[R1, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ANDS     R0,R1,R0
        LSLS     R0,R0,#+29
...
??exit_vlpr_1:
        LDR.N    R0,??DataTable13_10  ;; 0x4007d002
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+29
        BPL.N    ??exit_vlpr_1
//  182     
...
//  186     SIM_CLKDIV1 = 0x00010000;   //(SIM_CLKDIV1_OUTDIV1(1) | SIM_CLKDIV1_OUTDIV2(3) \ 
        MOVS     R0,#+65536
        LDR.N    R1,??DataTable13_5  ;; 0x40048044
        STR      R0,[R1, #+0]
...
//  221     SMC_PMPROT = SMC_PMPROT_AVLP_MASK;   // write oneif not all set make sure all enabled
        MOVS     R1,#+32
        LDR.N    R2,??DataTable13_1  ;; 0x4007e000
        STRB     R1,[R2, #+0]
...
//  229     if(lpwui_value){
        ...
        CMP      R0,#+0
        BEQ.N    ??enter_vlps_0
//  230        SMC_PMCTRL = (SMC_PMCTRL_LPWUI_MASK            // set LPWUI
//  231                   | SMC_PMCTRL_STOPM(2));           // set LPLLSM = 0b10
        MOVS     R0,#+130
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
        B.N      ??enter_vlps_1
//  232      } else {
//  233        SMC_PMCTRL = (!SMC_PMCTRL_LPWUI_MASK           // set LPWUI
//  234                   | SMC_PMCTRL_STOPM(2));           // set LPLLSM = 0b10
??enter_vlps_0:
        MOVS     R0,#+2
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
...
//  261     SMC_PMPROT = SMC_PMPROT_ALLS_MASK;   //this write-once bit allows the MCU to enter the
        MOVS     R0,#+8
        LDR.N    R1,??DataTable13_1  ;; 0x4007e000
        STRB     R0,[R1, #+0]
//  262                                        //LLS low power mode
//  263 
//  264         
//  265     /* Set the LPLLSM field to 0b011 for LLS mode  */
//  266     SMC_PMCTRL  =  SMC_PMCTRL_STOPM(3);           // set LPLLSM = 0b11
        MOVS     R0,#+3
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
//  267         
...
//  293    // SMC_PMPROT = SMC_PMPROT_AVLLS3_MASK;
//  294         
//  295     /* Set the LPLLSM field to 0b101 for VLLS3 mode  */
//  296     SMC_PMCTRL =  SMC_PMCTRL_STOPM(5);           // set LPLLSM = 0b101
        MOVS     R0,#+5
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
//  297     disable_ports();    
...
//  323    // SMC_PMPROT = SMC_PMPROT_AVLLS2_MASK;
//  324         
//  325     /* Set the LPLLSM field to 0b110 for VLLS2 mode */
//  326     SMC_PMCTRL =  SMC_PMCTRL_STOPM(6);           // set LPLLSM = 0b110
        MOVS     R0,#+6
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
//  327     disable_ports();    
...
//  354    // SMC_PMPROT = SMC_PMPROT_AVLLS1_MASK;
//  355         
//  356     /* Set the LPLLSM field to 0b111 for VLLS1 mode  */
//  357     SMC_PMCTRL =  SMC_PMCTRL_STOPM(7);           // set LPLLSM = 0b111
        MOVS     R0,#+7
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
//  358     disable_ports();    
...
//  378 {
//  379     SMC_PMCTRL |= SMC_PMCTRL_LPWUI_MASK;
enable_lpwui:
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x80
...
//  393 {
//  394     SMC_PMCTRL &= ~SMC_PMCTRL_LPWUI_MASK;
disable_lpwui:
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        ANDS     R0,R0,#0x7F
...
//  412     printf("--------------------------------------\n");
        ...
        BL       printf
//  413     
//  414     SMC_PMPROT = 0x37;               //This value enables all possible power modes.
        MOVS     R0,#+55
        LDR.N    R1,??DataTable13_1  ;; 0x4007e000
        STRB     R0,[R1, #+0]
//  415  
//  416     SMC_PMCTRL = SMC_PMCTRL_LPWUI_MASK | SMC_PMCTRL_STOPM(mode) ;  
        ANDS     R0,R4,#0x7
        ORRS     R0,R0,#0x80
        LDR.N    R1,??DataTable13  ;; 0x4007e001
        STRB     R0,[R1, #+0]
...
disable_ports:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_19  ;; 0x4004d068
        STR      R0,[R1, #+0]
//  423    PORTA_PCR19 = PORT_PCR_IRQC(00);
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_20  ;; 0x4004904c
        STR      R0,[R1, #+0]
//  424    #endif
//  425   
...
//  490   		PORTE_PCR8 = PORT_PCR_MUX(0x0); // UART is alt3 function for this pin
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_28  ;; 0x4004d020
        STR      R0,[R1, #+0]
//  491 
//  492   		/* Disable the UART3_RXD function on PTC16 */
//  493   		PORTE_PCR9 = PORT_PCR_MUX(0x0); // UART is alt3 function for this pin
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_29  ;; 0x4004d024
        STR      R0,[R1, #+0]
//  494   	}
//  495   // disable clock gating
//  496   SIM_SCGC1 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_30  ;; 0x40048028
        STR      R0,[R1, #+0]
//  497   SIM_SCGC2 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_31  ;; 0x4004802c
        STR      R0,[R1, #+0]
//  498   SIM_SCGC3 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_32  ;; 0x40048030
        STR      R0,[R1, #+0]
//  499   SIM_SCGC4 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_33  ;; 0x40048034
        STR      R0,[R1, #+0]
//  500   SIM_SCGC5 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_34  ;; 0x40048038
        STR      R0,[R1, #+0]
//  501   SIM_SCGC6 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_35  ;; 0x4004803c
        STR      R0,[R1, #+0]
//  502   SIM_SCGC7 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_36  ;; 0x40048040
        STR      R0,[R1, #+0]
//  503 
//  504 }
        BX       LR               ;; return
...
//  593   SIM_SCGC4 = SIM_SCGC4 & 0x70102030;  //LLWU(28), VREF(20), CMP(19), USBOTG(18), UART3 - 0(13-10), 
        LDR.N    R0,??DataTable13_33  ;; 0x40048034
        LDR      R0,[R0, #+0]
        LDR.N    R1,??DataTable13_37  ;; 0x70102030
        ANDS     R0,R1,R0
        LDR.N    R1,??DataTable13_33  ;; 0x40048034
        STR      R0,[R1, #+0]
...
outSRS:
        PUSH     {R7,LR}
//  608   if (RCM_SRS1 & RCM_SRS1_SW_MASK)
        LDR.N    R0,??DataTable13_38  ;; 0x4007f001
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+29
        BPL.N    ??outSRS_0
//  609 		printf("[outSRS]Software Reset\n");
        ...
        BL       printf
//  610 	if (RCM_SRS1 & RCM_SRS1_LOCKUP_MASK)
??outSRS_0:
        LDR.N    R0,??DataTable13_38  ;; 0x4007f001
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+30
...
//  611 		printf("[outSRS]Core Lockup Event Reset\n");
        ...
        BL       printf
//  612 	if (RCM_SRS1 & RCM_SRS1_JTAG_MASK)
??outSRS_1:
        LDR.N    R0,??DataTable13_38  ;; 0x4007f001
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  613 		printf("[outSRS]JTAG Reset\n");
        ...
        BL       printf
//  614 	
//  615 	if (RCM_SRS0 & RCM_SRS0_POR_MASK)
??outSRS_2:
        LDR.N    R0,??DataTable13_42  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+24
        BPL.N    ??outSRS_3
//  616 		printf("[outSRS]Power-on Reset\n");
        ...
        BL       printf
//  617 	if (RCM_SRS0 & RCM_SRS0_PIN_MASK){
??outSRS_3:
        LDR.N    R0,??DataTable13_42  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+25
...
//  619           printf("External Pin Reset\n");
        ...
        BL       printf
//  620 	}
//  621 	if (RCM_SRS0 & RCM_SRS0_WAKEUP_MASK){
??outSRS_4:
        LDR.N    R0,??DataTable13_42  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  626           if ((SMC_PMCTRL & SMC_PMCTRL_STOPM_MASK) == 0)
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        MOVS     R1,#+7
        TST      R0,R1
...
//  627              printf("[outSRS]Pin Reset wakeup from Normal Stop\n");
        ...
        BL       printf
//  628 	        if ((SMC_PMCTRL & SMC_PMCTRL_STOPM_MASK) == 2)
??outSRS_6:
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  629 		         printf("[outSRS]Pin Reset wakeup from Very Low Power Stop(VLPS)\n");
        ...
        BL       printf
//  630 		      if ((SMC_PMCTRL & SMC_PMCTRL_STOPM_MASK) == 3)
??outSRS_7:
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  631 		         printf("[outSRS]Pin Reset wakeup from Low Leakage Stop (LLS)\n");
        ...
        BL       printf
//  632 		      if ((SMC_PMCTRL & SMC_PMCTRL_STOPM_MASK) == 5 )
??outSRS_8:
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  633 		         printf("[outSRS]Pin Reset wakeup from Very low leakage stop (VLLS3)\n");
        ...
        BL       printf
//  634 		      if ((SMC_PMCTRL & SMC_PMCTRL_STOPM_MASK) == 6)
??outSRS_9:
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  635 		         printf("[outSRS]Pin Reset wakeup from Very low leakage stop (VLLS2)\n");
        ...
        BL       printf
//  636 		      if ((SMC_PMCTRL & SMC_PMCTRL_STOPM_MASK) == 7)		       
??outSRS_10:
        LDR.N    R0,??DataTable13  ;; 0x4007e001
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
??outSRS_11:
        LDR.N    R0,??DataTable13_1  ;; 0x4007e000
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
...
//  639           printf("[outSRS]MC PMCTRL= %#02X \r\n\n", (SMC_PMCTRL) ) ;
        ...
        BL       printf
//  640 	}
//  641 	if (RCM_SRS0 & RCM_SRS0_WDOG_MASK)
??outSRS_5:
        LDR.N    R0,??DataTable13_42  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
...
//  642 	 	printf("[outSRS]Watchdog(COP) Reset\n");
        ...
        BL       printf
//  643   if (RCM_SRS0 & RCM_SRS0_LOC_MASK)
??outSRS_12:
        LDR.N    R0,??DataTable13_42  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+29
...
//  644 		printf("[outSRS]Loss of Clock Reset\n");
        ...
        BL       printf
//  645 	if (RCM_SRS0 & RCM_SRS0_LVD_MASK)
??outSRS_13:
        LDR.N    R0,??DataTable13_42  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+30
...
//  646 	  printf("[outSRS]Low-voltage Detect Reset\n");
        ...
        BL       printf
//  647   if (RCM_SRS0 & RCM_SRS0_WAKEUP_MASK)
??outSRS_14:
        LDR.N    R0,??DataTable13_42  ;; 0x4007f000
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
