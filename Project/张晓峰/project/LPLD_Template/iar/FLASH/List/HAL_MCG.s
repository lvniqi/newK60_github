///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       11/Aug/2014  21:46:27
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\lib\LPLD\HAL_MCG.c
//    Command line =  
//        "C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\lib\LPLD\HAL_MCG.c" -D IAR
//        -D LPLD_K60 -lCN
...
//        -Ol
//    List file    =  
//        C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\project\LPLD_Template\iar\FLASH\List\HAL_MCG.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   62   SIM_SCGC4 |= SIM_SCGC4_LLWU_MASK;
        ...
        STR      R3,[R4, #+0]
//   63   PMC_REGSC |= PMC_REGSC_ACKISO_MASK;
        LDR.N    R3,??LPLD_PLL_Setup_2+0x8  ;; 0x4007d002
        LDRB     R3,[R3, #+0]
        ORRS     R3,R3,#0x8
        LDR.N    R4,??LPLD_PLL_Setup_2+0x8  ;; 0x4007d002
        STRB     R3,[R4, #+0]
//   64   
...
//   79   MCG_C5 = MCG_C5_PRDIV0(prdiv); // 设置 PLL 匹配晶振的参考分频数 
        ANDS     R2,R2,#0x1F
...
//   91       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(6); //VDIV = 6 (2x30) 60MHz
        MOVS     R0,#+70
...
??LPLD_PLL_Setup_6:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//   96       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(11); //VDIV = 11 (2x35) 70MHz
        MOVS     R0,#+75
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//   97       pll_freq = 70;
...
??LPLD_PLL_Setup_7:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  101       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(16); //VDIV = 16 (2x40) 80MHz
        MOVS     R0,#+80
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  102       pll_freq = 80;
...
??LPLD_PLL_Setup_8:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  106       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(21); //VDIV = 21 (2x45) 90MHz
        MOVS     R0,#+85
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  107       pll_freq = 90;
...
??LPLD_PLL_Setup_9:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  111       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(24); //VDIV = 24 (2x48) 96MHz
        MOVS     R0,#+88
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  112       pll_freq = 96;
...
??LPLD_PLL_Setup_10:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  116       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(26); //VDIV = 26 (2x50) 100MHz
        MOVS     R0,#+90
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  117       pll_freq = 100;
...
??LPLD_PLL_Setup_11:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  121       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(31); //VDIV = 31 (2x55) 110MHz
        MOVS     R0,#+95
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  122       pll_freq = 110;
...
??LPLD_PLL_Setup_12:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  126       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(7); //VDIV = 7 (3.846x31) 119.2MHz
        MOVS     R0,#+71
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  127       pll_freq = 120;
...
??LPLD_PLL_Setup_13:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  131       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(10); //VDIV = 10 (3.846x34) 130.8MHz
        MOVS     R0,#+74
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  132       pll_freq = 130;
...
??LPLD_PLL_Setup_14:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  136       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(15); //VDIV = 15 (3.846x39) 150MHz
        MOVS     R0,#+79
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  137       pll_freq = 150;
...
??LPLD_PLL_Setup_15:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  141       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(20); //VDIV = 20 (3.846x44) 169.2MHz
        MOVS     R0,#+84
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  142       pll_freq = 170;
...
??LPLD_PLL_Setup_16:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  146       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(23); //VDIV = 23 (3.846x47) 180.8MHz
        MOVS     R0,#+87
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  147       pll_freq = 180;
...
??LPLD_PLL_Setup_17:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  151       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(28); //VDIV = 28 (3.846x52) 200MHz
        MOVS     R0,#+92
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  152       pll_freq = 200;
...
??LPLD_PLL_Setup_18:
        ...
        MOVS     R0,#+0
        BL       LPLD_Set_SYS_DIV
//  156       MCG_C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(26); //VDIV = 26 (4.17x50) 208.5MHz
        MOVS     R0,#+90
        LDR.N    R1,??LPLD_PLL_Setup_2+0x18  ;; 0x40064005
        STRB     R0,[R1, #+0]
//  157       pll_freq = 209;
...
//  161   
//  162   while (!(MCG_S & MCG_S_LOCK0_MASK)){}; // Wait for LOCK bit to set
??LPLD_PLL_Setup_23:
        LDR.N    R0,??LPLD_PLL_Setup_2+0x10  ;; 0x40064006
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+25
...
//  181  * 设置系统始终分频(FSCL官方代码)
//  182  *
//  183  * 说明:
//  184  * 这段代码必须放置在RAM中. It is a workaround for errata e2448.
//  185  * 当Flash时钟分频改变的时候，Flash预读取必须禁用.
//  186  * 当正在从Flash执行的时候这里不能执行.
...
//  192 #if (defined(IAR))
        ...
        THUMB
//  193 	__ramfunc void LPLD_Set_SYS_DIV(uint32 outdiv1, uint32 outdiv2, uint32 outdiv3, uint32 outdiv4)
//  194 #elif (defined(CW))
//  195 __relocate_code__ 
//  196 void LPLD_Set_SYS_DIV(uint32 outdiv1, uint32 outdiv2, uint32 outdiv3, uint32 outdiv4)
//  197 #endif
//  198 {
LPLD_Set_SYS_DIV:
        PUSH     {R4-R6}
...
//  200   uint8 i;
//  201   
//  202   temp_reg = FMC_PFAPR; // 备份 FMC_PFAPR 寄存器
        LDR.N    R4,??LPLD_Set_SYS_DIV_0  ;; 0x4001f000
        LDR      R4,[R4, #+0]
//  203   
//  204   // 设置 M0PFD 到 M7PFD 为 1 禁用预先读取
//  205   FMC_PFAPR |= FMC_PFAPR_M7PFD_MASK | FMC_PFAPR_M6PFD_MASK | FMC_PFAPR_M5PFD_MASK
//  206              | FMC_PFAPR_M4PFD_MASK | FMC_PFAPR_M3PFD_MASK | FMC_PFAPR_M2PFD_MASK
//  207              | FMC_PFAPR_M1PFD_MASK | FMC_PFAPR_M0PFD_MASK;
...
//  208   
//  209   // 设置时钟分频为期望值  
//  210   SIM_CLKDIV1 = SIM_CLKDIV1_OUTDIV1(outdiv1) | SIM_CLKDIV1_OUTDIV2(outdiv2) 
//  211               | SIM_CLKDIV1_OUTDIV3(outdiv3) | SIM_CLKDIV1_OUTDIV4(outdiv4);
        LSLS     R1,R1,#+24
...
//  215   {}
//  216   
//  217   FMC_PFAPR = temp_reg; // 回复原先的 FMC_PFAPR 寄存器值
