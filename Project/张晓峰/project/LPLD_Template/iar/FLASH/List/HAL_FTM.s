...
//    Endian       =  little
//    Source file  =  
//        C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\lib\LPLD\HAL_FTM.c
//    Command line =  
//        "C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\lib\LPLD\HAL_FTM.c" -D IAR
//        -D LPLD_K60 -lCN
...
//        -Ol
//    List file    =  
//        C:\Users\zxf\Desktop\8.10\7.17(CCD修改)\project\LPLD_Template\iar\FLASH\List\HAL_FTM.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  128   FTM0_CNT = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_2  ;; 0x40038004
        STR      R0,[R1, #+0]
//  129   FTM0_CNTIN = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_3  ;; 0x4003804c
        STR      R0,[R1, #+0]
//  130   // 配置FTM计数MOD值
//  131   FTM0_MOD = LPLD_FTM0_MOD;
        LDR.W    R0,??DataTable10_1
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable12_4  ;; 0x40038008
        STR      R0,[R1, #+0]
//  132   
//  133   return 1;
        MOVS     R0,#+1
...
??LPLD_FTM0_PWM_Open_5:
        MOVS     R2,#+40
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R3,??DataTable12_6  ;; 0x4003800c
        STR      R2,[R3, R0, LSL #+3]
//  193   // 配置FTM通道值
...
??LPLD_FTM0_PWM_Open_3:
        ...
        MOV      R2,#+1024
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R3,??DataTable12_7  ;; 0x4004c000
        STR      R2,[R3, R0, LSL #+2]
...
//  313   FTM1_CNT = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_10  ;; 0x40039004
        STR      R0,[R1, #+0]
//  314   FTM1_CNTIN = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_11  ;; 0x4003904c
        STR      R0,[R1, #+0]
//  315   // 配置FTM计数MOD值
//  316   FTM1_MOD = LPLD_FTM1_MOD;
        LDR.W    R0,??DataTable12_8
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable12_12  ;; 0x40039008
        STR      R0,[R1, #+0]
//  317   
//  318   return 1;
        MOVS     R0,#+1
...
//  362   FTM_CnSC_REG(FTM1_BASE_PTR, channel) = FTM_CnSC_MSB_MASK|FTM_CnSC_ELSB_MASK;
        MOVS     R2,#+40
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R3,??DataTable12_13  ;; 0x4003900c
        STR      R2,[R3, R0, LSL #+3]
//  363   // 配置FTM通道值
...
//  478   FTM2_CNT = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_17  ;; 0x400b8004
        STR      R0,[R1, #+0]
//  479   FTM2_CNTIN = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_18  ;; 0x400b804c
        STR      R0,[R1, #+0]
//  480   // 配置FTM计数MOD值
//  481   FTM2_MOD = LPLD_FTM2_MOD;
        LDR.W    R0,??DataTable12_14
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable12_19  ;; 0x400b8008
        STR      R0,[R1, #+0]
//  482   
//  483   return 1;
        MOVS     R0,#+1
...
//  527   FTM_CnSC_REG(FTM2_BASE_PTR, channel) = FTM_CnSC_MSB_MASK|FTM_CnSC_ELSB_MASK;
        MOVS     R2,#+40
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R3,??DataTable12_20  ;; 0x400b800c
        STR      R2,[R3, R0, LSL #+3]
//  528   // 配置FTM通道值
...
//  604   SIM_SCGC6 |= SIM_SCGC6_FTM0_MASK;
        ...
        LDR.W    R5,??DataTable12  ;; 0x4004803c
        STR      R4,[R5, #+0]
//  605   
//  606   FTM0_CONF=FTM_CONF_BDMMODE(0x3);
        MOVS     R4,#+192
        LDR.W    R5,??DataTable12_21  ;; 0x40038084
        STR      R4,[R5, #+0]
//  607 
//  608   if(ps==7)
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
...
//  674   FTM0_CNT = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_2  ;; 0x40038004
        STR      R2,[R4, #+0]
//  675   FTM0_CNTIN = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_3  ;; 0x4003804c
        STR      R2,[R4, #+0]
//  676   FTM0_MOD = 0;                           
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_4  ;; 0x40038008
        STR      R2,[R4, #+0]
//  677   FTM0_QDCTRL = (~FTM_QDCTRL_QUADEN_MASK); //关闭正交解码
        MVNS     R2,#+1
        LDR.W    R4,??DataTable12_24  ;; 0x40038080
        STR      R2,[R4, #+0]
//  678   FTM0_FILTER = 0x00;                      //关过虑器
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_25  ;; 0x40038078
        STR      R2,[R4, #+0]
//  679  
...
??LPLD_FTM0_InputCapture_Init_3:
        MOV      R4,#+1024
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R5,??DataTable12_7  ;; 0x4004c000
        STR      R4,[R5, R0, LSL #+2]
...
//  751   FTM1_CONF=FTM_CONF_BDMMODE(0x3);
        MOVS     R4,#+192
        LDR.W    R5,??DataTable12_27  ;; 0x40039084
        STR      R4,[R5, #+0]
//  752 
//  753   if(ps==7)
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
...
//  811   FTM1_CNT = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_10  ;; 0x40039004
        STR      R2,[R4, #+0]
//  812   FTM1_CNTIN = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_11  ;; 0x4003904c
        STR      R2,[R4, #+0]
//  813   FTM1_MOD = 0;                           
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_12  ;; 0x40039008
        STR      R2,[R4, #+0]
//  814   FTM1_QDCTRL = (~FTM_QDCTRL_QUADEN_MASK); //关闭正交解码
        MVNS     R2,#+1
        LDR.W    R4,??DataTable12_30  ;; 0x40039080
        STR      R2,[R4, #+0]
//  815   FTM1_FILTER = 0x00;                      //关过虑器
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_31  ;; 0x40039078
        STR      R2,[R4, #+0]
//  816  
...
//  889   FTM2_CONF=FTM_CONF_BDMMODE(0x3);
        MOVS     R4,#+192
        LDR.N    R5,??DataTable12_32  ;; 0x400b8084
        STR      R4,[R5, #+0]
//  890 
//  891   if(ps==7)
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
...
//  949   FTM2_CNT = 0;
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_17  ;; 0x400b8004
        STR      R2,[R4, #+0]
//  950   FTM2_CNTIN = 0;
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_18  ;; 0x400b804c
        STR      R2,[R4, #+0]
//  951   FTM2_MOD = 0;                           
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_19  ;; 0x400b8008
        STR      R2,[R4, #+0]
//  952   FTM2_QDCTRL = (~FTM_QDCTRL_QUADEN_MASK); //关闭正交解码
        MVNS     R2,#+1
        LDR.N    R4,??DataTable12_35  ;; 0x400b8080
        STR      R2,[R4, #+0]
//  953   FTM2_FILTER = 0x00;                      //关过虑器
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_36  ;; 0x400b8078
        STR      R2,[R4, #+0]
//  954  
