...
//    Endian       =  little
//    Source file  =  
//        C:\Users\zxf\Desktop\8.16\7.17(CCD修改)\project\LPLD_Template\app\LPLD_Template.c
//    Command line =  
//        "C:\Users\zxf\Desktop\8.16\7.17(CCD修改)\project\LPLD_Template\app\LPLD_Template.c"
...
//        -Ol
//    List file    =  
//        C:\Users\zxf\Desktop\8.16\7.17(CCD修改)\project\LPLD_Template\iar\FLASH\List\LPLD_Template.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   82   {
//   83 /*
//   84     OutData[0] = ave_error;
//   85     OutData[1] = lasterror;
//   86     
//   87     OutData[2] = temp_pwm-Servomiddle;
...
//   99          //OLED_CLS();
//  100          OLED_Fill(0x00);
//  101          for(ccd_cownum=10+CCD_left*Abs(temp_pwm-Servomiddle)/5; ccd_cownum<123-CCD_right*Abs(temp_pwm-Servomiddle)/5; ccd_cownum++)
//  102          {
...
//  140          OLED_writenum_4(60,4,straight_speed);
        ...
        MOVS     R0,#+60
        BL       OLED_writenum_4
//  141          OLED_writenum_4(60,3,LPLD_ADC_SE_Get(ADC1, 14));
        MOVS     R1,#+14
        MOVS     R0,#+1
        BL       LPLD_ADC_SE_Get
...
//  144          OLED_writenum_4(96,4,Abs(temp_pwm-Servomiddle));
        LDR.W    R0,??DataTable1_20
        LDR      R0,[R0, #+0]
        BL       __aeabi_f2d
        MOVS     R2,#+0
        LDR.W    R3,??DataTable1_21  ;; 0xc0a4ea00
        BL       __aeabi_dadd
        BL       __aeabi_d2f
        BL       Abs
        BL       __aeabi_f2iz
...
??main_6:
        ...
        MOVS     R1,R4
        BL       __aeabi_fmul
        LDR.W    R1,??DataTable1_38  ;; 0x40a00000
        BL       __aeabi_fdiv
        LDR.W    R1,??DataTable1_39  ;; 0x41200000
        BL       __aeabi_fadd
        BL       __aeabi_f2iz
...
??main_7:
        ...
        BL       __aeabi_fdiv
        MOVS     R1,R0
        LDR.W    R0,??DataTable1_42  ;; 0x42f60000
        BL       __aeabi_fsub
        MOVS     R1,R0
        MOVS     R4,R1
...
??pit_isr0_6:
        ...
        CMP      R0,#+1
        BNE.N    ??pit_isr0_7
        LDR.W    R0,??DataTable1_50
        LDRH     R0,[R0, #+0]
        ADDS     R0,R0,#+1
        LDR.W    R1,??DataTable1_50
        STRH     R0,[R1, #+0]
//  215     if(pd_flag>500) lock_pd=0;
??pit_isr0_7:
        LDR.W    R0,??DataTable1_50
        LDRH     R0,[R0, #+0]
        CMP      R0,#+500
...
??pit_isr0_16:
        ...
        BL       __aeabi_f2d
        MOVS     R2,#+0
        LDR.N    R3,??DataTable1_21  ;; 0xc0a4ea00
        BL       __aeabi_dadd
        BL       __aeabi_d2f
        BL       Abs
        LDR.N    R1,??DataTable1_56  ;; 0x42a00000
        BL       __aeabi_cfcmple
        BCS.N    ??pit_isr0_17
...
//  285         if(Abs(ave_error)<30&&need_data2>100&&(need_data0>100||need_data1>100)&&Abs(temp_pwm-Servomiddle)<160)
        ...
        LDR      R0,[R0, #+0]
        BL       Abs
        LDR.N    R1,??DataTable1_60  ;; 0x41f00000
        BL       __aeabi_cfcmple
        BCS.N    ??pit_isr0_22
...
??pit_isr0_23:
        ...
        BL       __aeabi_d2f
        BL       Abs
        LDR.N    R1,??DataTable1_61  ;; 0x43200000
        BL       __aeabi_cfcmple
        BCS.N    ??pit_isr0_22
//  286         {
...
??pit_isr0_26:
        ...
        BL       __aeabi_d2f
        BL       Abs
        LDR.N    R1,??DataTable1_64  ;; 0x42480000
        BL       __aeabi_cfrcmple
        BHI.N    ??pit_isr0_28
//  315         {
//  316            straight_l=0;
...
//  327            Beep_On();
        ...
        BL       LPLD_GPIO_Set_b
//  328            Beep++;
        LDR.N    R0,??DataTable1_66
        LDRH     R0,[R0, #+0]
        ADDS     R0,R0,#+1
        LDR.N    R1,??DataTable1_66
        STRH     R0,[R1, #+0]
//  329            if(Beep>=40)
        LDR.N    R0,??DataTable1_66
        LDRH     R0,[R0, #+0]
