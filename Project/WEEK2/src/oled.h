 ...
 ******************************************************************************/
  ...
  #define OLED_RST 				PBout(22)
    //PG15输出 复位信号 这里复位信号端口自己配置即可~~
  ...
  extern void OLED_P6x8Char(unsigned char ucIdxX, unsigned char ucIdxY,
    unsigned char ucData);
  extern void OLED_P6x8Str(unsigned char ucIdxX, unsigned char ucIdxY, unsigned
    char ucDataStr[]);
  ...
  extern void OLED_PrintShort(unsigned char ucIdxX, unsigned char ucIdxY, short
    int sData);
