...
void speed_control(){
  ...
  Motorerr_r = kp_r *(e0motor_r - e1motor_r) + ki_r * e0motor_r + kd_r *
    (e0motor_r - 2 * e1motor_r + e2motor_r);

  Motorpwm_r += (int)Motorerr_r;

  Motorerr_l = kp_l *(e0motor_l - e1motor_l) + ki_l * e0motor_l + kd_l *
    (e0motor_l - 2 * e1motor_l + e2motor_l);
