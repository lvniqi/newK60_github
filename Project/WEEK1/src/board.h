...
#define BOARD_SPI_MAP               SPI0_SCK_PA15_SOUT_PA16_SIN_PA17
#define BOARD_SPI_CS_PORT           HW_GPIOA
#define BOARD_SPI_CS_PIN            (14)
//#define BOARD_SPI_CS                (14)
#define BOARD_NRF2401_IRQ_PORT      HW_GPIOA
#define BOARD_NRF2401_IRQ_PIN       (11)
