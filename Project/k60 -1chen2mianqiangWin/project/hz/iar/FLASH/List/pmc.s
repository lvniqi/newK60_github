///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.20.2.7424/W32 for ARM       19/Mar/2015  11:05:12
...
//        -1chen2mianqiangWin\lib\drivers\pmc\pmc.c
//    Command line =  
//        "G:\GitHub\newK60_github\Project\k60
//        -1chen2mianqiangWin\lib\drivers\pmc\pmc.c" -D IAR -D LPLD_K60 -lCN
//        "G:\GitHub\newK60_github\Project\k60
...
//    List file    =  
//        G:\GitHub\newK60_github\Project\k60
//        -1chen2mianqiangWin\project\hz\iar\FLASH\List\pmc.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\GitHub\newK60_github\Project\k60 -1chen2mianqiangWin\lib\drivers\pmc\pmc.c
//    1 /*
//    2  * File:        pmc.c
...
//   87     MC_PMCTRL =  MC_PMCTRL_LPLLSM(0);           // set LPLLSM = 0b000
        MOVS     R0,#+0
        LDR.W    R1,??DataTable13  ;; 0x4007e003
        STRB     R0,[R1, #+0]
//   88     stop();
        BL       stop
//   89 }
...
//  109      MC_PMPROT = MC_PMPROT_AVLP_MASK;  // write oneif not all set make sure all enabled
        MOVS     R0,#+32
        LDR.W    R1,??DataTable13_1  ;; 0x4007e002
        STRB     R0,[R1, #+0]
...
//  221     MC_PMPROT = MC_PMPROT_AVLP_MASK;   // write oneif not all set make sure all enabled
        MOVS     R1,#+32
        LDR.N    R2,??DataTable13_1  ;; 0x4007e002
        STRB     R1,[R2, #+0]
...
disable_ports:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_18  ;; 0x4004d068
        STR      R0,[R1, #+0]
//  423    PORTA_PCR19 = PORT_PCR_IRQC(00);
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_19  ;; 0x4004904c
        STR      R0,[R1, #+0]
//  424    #endif
//  425   
...
//  490   		PORTE_PCR8 = PORT_PCR_MUX(0x0); // UART is alt3 function for this pin
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_27  ;; 0x4004d020
        STR      R0,[R1, #+0]
//  491 
//  492   		/* Disable the UART3_RXD function on PTC16 */
//  493   		PORTE_PCR9 = PORT_PCR_MUX(0x0); // UART is alt3 function for this pin
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_28  ;; 0x4004d024
        STR      R0,[R1, #+0]
//  494   	}
//  495   // disable clock gating
//  496   SIM_SCGC1 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_29  ;; 0x40048028
        STR      R0,[R1, #+0]
//  497   SIM_SCGC2 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_30  ;; 0x4004802c
        STR      R0,[R1, #+0]
//  498   SIM_SCGC3 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_31  ;; 0x40048030
        STR      R0,[R1, #+0]
//  499   SIM_SCGC4 = 0;
        MOVS     R0,#+0
...
//  500   SIM_SCGC5 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_33  ;; 0x40048038
        STR      R0,[R1, #+0]
//  501   SIM_SCGC6 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_34  ;; 0x4004803c
        STR      R0,[R1, #+0]
//  502   SIM_SCGC7 = 0;
        MOVS     R0,#+0
        LDR.N    R1,??DataTable13_35  ;; 0x40048040
        STR      R0,[R1, #+0]
//  503 
//  504 }
        BX       LR               ;; return
