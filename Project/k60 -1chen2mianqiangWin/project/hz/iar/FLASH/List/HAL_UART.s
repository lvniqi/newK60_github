...
//        -1chen2mianqiangWin\lib\LPLD\HAL_UART.c
//    Command line =  
//        "G:\GitHub\newK60_github\Project\k60
//        -1chen2mianqiangWin\lib\LPLD\HAL_UART.c" -D IAR -D LPLD_K60 -lCN
//        "G:\GitHub\newK60_github\Project\k60
...
//    List file    =  
//        G:\GitHub\newK60_github\Project\k60
//        -1chen2mianqiangWin\project\hz\iar\FLASH\List\HAL_UART.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\GitHub\newK60_github\Project\k60 -1chen2mianqiangWin\lib\LPLD\HAL_UART.c
//    1 /*
//    2  * --------------"拉普兰德K60底层库"-----------------
//    3  *
...
//  100     PORTB_PCR17 = PORT_PCR_MUX(0x3); 
        MOV      R3,#+768
        LDR.N    R4,??DataTable5_6  ;; 0x4004a044
        STR      R3,[R4, #+0]
//  101     //使能 PTB16 引脚的 UART0_RXD 功能 
//  102     PORTB_PCR16 = PORT_PCR_MUX(0x3);
        MOV      R3,#+768
        LDR.N    R4,??DataTable5_7  ;; 0x4004a040
        STR      R3,[R4, #+0]
...
//  131           PORTC_PCR17 = PORT_PCR_MUX(0x3); 
        MOV      R3,#+768
        LDR.N    R4,??DataTable5_14  ;; 0x4004b044
        STR      R3,[R4, #+0]
//  132           //使能 PTC16 引脚的 UART3_RXD 功能 
//  133           PORTC_PCR16 = PORT_PCR_MUX(0x3);
        MOV      R3,#+768
        LDR.N    R4,??DataTable5_15  ;; 0x4004b040
        STR      R3,[R4, #+0]
        B.N      ??LPLD_UART_Init_7
//  134         }
//  135         else
