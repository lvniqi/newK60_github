///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.20.2.7424/W32 for ARM       19/Mar/2015  11:05:02
...
//        -1chen2mianqiangWin\lib\LPLD\HAL_FTM.c
//    Command line =  
//        "G:\GitHub\newK60_github\Project\k60
//        -1chen2mianqiangWin\lib\LPLD\HAL_FTM.c" -D IAR -D LPLD_K60 -lCN
//        "G:\GitHub\newK60_github\Project\k60
...
//    List file    =  
//        G:\GitHub\newK60_github\Project\k60
//        -1chen2mianqiangWin\project\hz\iar\FLASH\List\HAL_FTM.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\GitHub\newK60_github\Project\k60 -1chen2mianqiangWin\lib\LPLD\HAL_FTM.c
//    1 /*
//    2  * --------------"拉普兰德K60底层库"-----------------
//    3  *
...
//  123   FTM0_SC = FTM_SC_CLKS(1)|FTM_SC_PS(ps);
        ...
        ANDS     R0,R2,#0x7
        ORRS     R0,R0,#0x8
        LDR.W    R1,??DataTable12  ;; 0x40038000
        STR      R0,[R1, #+0]
//  124   
//  125   // 设置PWM周期及占空比
...
//  128   FTM0_CNT = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_1  ;; 0x40038004
        STR      R0,[R1, #+0]
//  129   FTM0_CNTIN = 0;
        MOVS     R0,#+0
...
//  131   FTM0_MOD = LPLD_FTM0_MOD;
        LDR.W    R0,??DataTable10_1
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable12_3  ;; 0x40038008
        STR      R0,[R1, #+0]
//  132   
//  133   return 1;
        MOVS     R0,#+1
...
??LPLD_FTM0_PWM_Open_2:
        LDR.W    R2,??DataTable12_4  ;; 0x40048038
        LDR      R2,[R2, #+0]
        ORRS     R2,R2,#0x800
        LDR.W    R3,??DataTable12_4  ;; 0x40048038
        STR      R2,[R3, #+0]
...
??LPLD_FTM0_PWM_Open_5:
        MOVS     R2,#+40
        LDR.W    R3,??DataTable12_5  ;; 0x4003800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R2,[R3, R0, LSL #+3]
//  193   // 配置FTM通道值
//  194   FTM_CnV_REG(FTM0_BASE_PTR, channel) = cv;
        LDR.W    R2,??DataTable12_5  ;; 0x4003800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        ADDS     R0,R2,R0, LSL #+3
        STR      R1,[R0, #+4]
//  195   
...
??LPLD_FTM0_PWM_Open_3:
        ...
        STR      R2,[R3, #+0]
        MOV      R2,#+1024
        LDR.W    R3,??DataTable12_6  ;; 0x4004c000
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R2,[R3, R0, LSL #+2]
...
//  308   FTM1_SC = FTM_SC_CLKS(1)|FTM_SC_PS(ps);
        ...
        ANDS     R0,R2,#0x7
        ORRS     R0,R0,#0x8
        LDR.W    R1,??DataTable12_8  ;; 0x40039000
        STR      R0,[R1, #+0]
//  309   
//  310   // 设置PWM周期及占空比
...
//  313   FTM1_CNT = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_9  ;; 0x40039004
        STR      R0,[R1, #+0]
//  314   FTM1_CNTIN = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_10  ;; 0x4003904c
        STR      R0,[R1, #+0]
//  315   // 配置FTM计数MOD值
//  316   FTM1_MOD = LPLD_FTM1_MOD;
        LDR.W    R0,??DataTable12_7
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable12_11  ;; 0x40039008
        STR      R0,[R1, #+0]
//  317   
//  318   return 1;
        MOVS     R0,#+1
...
//  362   FTM_CnSC_REG(FTM1_BASE_PTR, channel) = FTM_CnSC_MSB_MASK|FTM_CnSC_ELSB_MASK;
        MOVS     R2,#+40
        LDR.W    R3,??DataTable12_12  ;; 0x4003900c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R2,[R3, R0, LSL #+3]
//  363   // 配置FTM通道值
//  364   FTM_CnV_REG(FTM1_BASE_PTR, channel) = cv;
        LDR.W    R2,??DataTable12_12  ;; 0x4003900c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        ADDS     R0,R2,R0, LSL #+3
        STR      R1,[R0, #+4]
//  365   
...
??LPLD_FTM2_PWM_Init_3:
        LDR.W    R0,??DataTable12_14  ;; 0x40048030
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1000000
        LDR.W    R1,??DataTable12_14  ;; 0x40048030
        STR      R0,[R1, #+0]
//  469   
//  470   // 配置FTM控制寄存器
...
//  473   FTM2_SC = FTM_SC_CLKS(1)|FTM_SC_PS(ps);
        ...
        ANDS     R0,R2,#0x7
        ORRS     R0,R0,#0x8
        LDR.W    R1,??DataTable12_15  ;; 0x400b8000
        STR      R0,[R1, #+0]
//  474   
//  475   // 设置PWM周期及占空比
...
//  478   FTM2_CNT = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_16  ;; 0x400b8004
        STR      R0,[R1, #+0]
//  479   FTM2_CNTIN = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable12_17  ;; 0x400b804c
        STR      R0,[R1, #+0]
//  480   // 配置FTM计数MOD值
//  481   FTM2_MOD = LPLD_FTM2_MOD;
        LDR.W    R0,??DataTable12_13
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable12_18  ;; 0x400b8008
        STR      R0,[R1, #+0]
//  482   
//  483   return 1;
        MOVS     R0,#+1
...
//  527   FTM_CnSC_REG(FTM2_BASE_PTR, channel) = FTM_CnSC_MSB_MASK|FTM_CnSC_ELSB_MASK;
        MOVS     R2,#+40
        LDR.W    R3,??DataTable12_19  ;; 0x400b800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R2,[R3, R0, LSL #+3]
//  528   // 配置FTM通道值
//  529   FTM_CnV_REG(FTM2_BASE_PTR, channel) = cv;
        LDR.W    R2,??DataTable12_19  ;; 0x400b800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        ADDS     R0,R2,R0, LSL #+3
        STR      R1,[R0, #+4]
//  530   
...
//  606   FTM0_CONF=FTM_CONF_BDMMODE(0x3);
        MOVS     R4,#+192
        LDR.W    R5,??DataTable12_20  ;; 0x40038084
        STR      R4,[R5, #+0]
//  607 
//  608   if(ps==7)
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
...
??LPLD_FTM0_InputCapture_Init_5:
        LDR.W    R4,??DataTable12_22  ;; 0x40038054
        LDR      R4,[R4, #+0]
        LSRS     R4,R4,#+1
        LSLS     R4,R4,#+1
        LDR.W    R5,??DataTable12_22  ;; 0x40038054
        STR      R4,[R5, #+0]
//  665   
//  666   // 配置FTM控制寄存器
...
//  670   FTM0_SC |= FTM_SC_CLKS(1)|FTM_SC_PS(ps);
        LDR.W    R4,??DataTable12  ;; 0x40038000
        LDR      R4,[R4, #+0]
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        ANDS     R2,R2,#0x7
        ORRS     R2,R2,#0x8
...
//  671   FTM0_SC |= FTM_SC_TOIE_MASK;             //使能计数溢出中断
        LDR.W    R2,??DataTable12  ;; 0x40038000
        LDR      R2,[R2, #+0]
        ORRS     R2,R2,#0x40
        LDR.W    R4,??DataTable12  ;; 0x40038000
        STR      R2,[R4, #+0]
...
//  674   FTM0_CNT = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_1  ;; 0x40038004
        STR      R2,[R4, #+0]
//  675   FTM0_CNTIN = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_2  ;; 0x4003804c
        STR      R2,[R4, #+0]
//  676   FTM0_MOD = 0;                           
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_3  ;; 0x40038008
        STR      R2,[R4, #+0]
//  677   FTM0_QDCTRL = (~FTM_QDCTRL_QUADEN_MASK); //关闭正交解码
        MVNS     R2,#+1
        LDR.W    R4,??DataTable12_23  ;; 0x40038080
        STR      R2,[R4, #+0]
//  678   FTM0_FILTER = 0x00;                      //关过虑器
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_24  ;; 0x40038078
        STR      R2,[R4, #+0]
//  679  
//  680   FTM_CnSC_REG(FTM0_BASE_PTR, channel) = 0x00;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_5  ;; 0x4003800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R2,[R4, R0, LSL #+3]
...
//  687     FTM_CnSC_REG(FTM0_BASE_PTR, channel) &= (~FTM_CnSC_ELSB_MASK);  
        LDR.W    R1,??DataTable12_5  ;; 0x4003800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR      R1,[R1, R0, LSL #+3]
        BICS     R1,R1,#0x8
        LDR.W    R2,??DataTable12_5  ;; 0x4003800c
...
??LPLD_FTM0_InputCapture_Init_3:
        MOV      R4,#+1024
        LDR.W    R5,??DataTable12_6  ;; 0x4004c000
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R4,[R5, R0, LSL #+2]
...
//  751   FTM1_CONF=FTM_CONF_BDMMODE(0x3);
        MOVS     R4,#+192
        LDR.W    R5,??DataTable12_26  ;; 0x40039084
        STR      R4,[R5, #+0]
//  752 
//  753   if(ps==7)
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
...
//  801   FTM1_MODE &=(~FTM_MODE_FTMEN_MASK);       //使能FTM全功能
        LDR.W    R4,??DataTable12_28  ;; 0x40039054
        LDR      R4,[R4, #+0]
        LSRS     R4,R4,#+1
        LSLS     R4,R4,#+1
        LDR.W    R5,??DataTable12_28  ;; 0x40039054
        STR      R4,[R5, #+0]
//  802   
//  803   // 配置FTM控制寄存器
...
//  807   FTM1_SC |= FTM_SC_CLKS(1)|FTM_SC_PS(ps);
        LDR.W    R4,??DataTable12_8  ;; 0x40039000
        LDR      R4,[R4, #+0]
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        ANDS     R2,R2,#0x7
        ORRS     R2,R2,#0x8
...
//  808   FTM1_SC |= FTM_SC_TOIE_MASK;             //使能计数溢出中断
        LDR.W    R2,??DataTable12_8  ;; 0x40039000
        LDR      R2,[R2, #+0]
        ORRS     R2,R2,#0x40
        LDR.W    R4,??DataTable12_8  ;; 0x40039000
        STR      R2,[R4, #+0]
...
//  811   FTM1_CNT = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_9  ;; 0x40039004
        STR      R2,[R4, #+0]
//  812   FTM1_CNTIN = 0;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_10  ;; 0x4003904c
        STR      R2,[R4, #+0]
//  813   FTM1_MOD = 0;                           
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_11  ;; 0x40039008
        STR      R2,[R4, #+0]
//  814   FTM1_QDCTRL = (~FTM_QDCTRL_QUADEN_MASK); //关闭正交解码
        MVNS     R2,#+1
        LDR.W    R4,??DataTable12_29  ;; 0x40039080
        STR      R2,[R4, #+0]
//  815   FTM1_FILTER = 0x00;                      //关过虑器
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_30  ;; 0x40039078
        STR      R2,[R4, #+0]
//  816  
//  817   FTM_CnSC_REG(FTM1_BASE_PTR, channel) = 0x00;
        MOVS     R2,#+0
        LDR.W    R4,??DataTable12_12  ;; 0x4003900c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R2,[R4, R0, LSL #+3]
...
//  824     FTM_CnSC_REG(FTM1_BASE_PTR, channel) &= (~FTM_CnSC_ELSB_MASK);  
        LDR.W    R1,??DataTable12_12  ;; 0x4003900c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR      R1,[R1, R0, LSL #+3]
        BICS     R1,R1,#0x8
        LDR.W    R2,??DataTable12_12  ;; 0x4003900c
...
??LPLD_FTM1_InputCapture_Init_4:
        ...
        LDR.N    R1,??DataTable12_12  ;; 0x4003900c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR      R1,[R1, R0, LSL #+3]
        ORRS     R1,R1,#0x8
        LDR.N    R2,??DataTable12_12  ;; 0x4003900c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R1,[R2, R0, LSL #+3]
        LDR.N    R1,??DataTable12_12  ;; 0x4003900c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  887   SIM_SCGC3 |= SIM_SCGC3_FTM2_MASK;
        LDR.N    R4,??DataTable12_14  ;; 0x40048030
        LDR      R4,[R4, #+0]
        ORRS     R4,R4,#0x1000000
        LDR.N    R5,??DataTable12_14  ;; 0x40048030
        STR      R4,[R5, #+0]
//  888   
//  889   FTM2_CONF=FTM_CONF_BDMMODE(0x3);
        MOVS     R4,#+192
        LDR.N    R5,??DataTable12_31  ;; 0x400b8084
        STR      R4,[R5, #+0]
//  890 
//  891   if(ps==7)
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
...
//  939   FTM2_MODE &=(~FTM_MODE_FTMEN_MASK);       //使能FTM全功能
        LDR.N    R4,??DataTable12_33  ;; 0x400b8054
        LDR      R4,[R4, #+0]
        LSRS     R4,R4,#+1
        LSLS     R4,R4,#+1
        LDR.N    R5,??DataTable12_33  ;; 0x400b8054
        STR      R4,[R5, #+0]
//  940   
//  941   // 配置FTM控制寄存器
...
//  945   FTM2_SC |= FTM_SC_CLKS(1)|FTM_SC_PS(ps);
        LDR.N    R4,??DataTable12_15  ;; 0x400b8000
        LDR      R4,[R4, #+0]
        UXTB     R2,R2            ;; ZeroExt  R2,R2,#+24,#+24
        ANDS     R2,R2,#0x7
        ORRS     R2,R2,#0x8
...
//  946   FTM2_SC |= FTM_SC_TOIE_MASK;             //使能计数溢出中断
        LDR.N    R2,??DataTable12_15  ;; 0x400b8000
        LDR      R2,[R2, #+0]
        ORRS     R2,R2,#0x40
        LDR.N    R4,??DataTable12_15  ;; 0x400b8000
        STR      R2,[R4, #+0]
...
//  949   FTM2_CNT = 0;
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_16  ;; 0x400b8004
        STR      R2,[R4, #+0]
//  950   FTM2_CNTIN = 0;
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_17  ;; 0x400b804c
        STR      R2,[R4, #+0]
//  951   FTM2_MOD = 0;                           
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_18  ;; 0x400b8008
        STR      R2,[R4, #+0]
//  952   FTM2_QDCTRL = (~FTM_QDCTRL_QUADEN_MASK); //关闭正交解码
        MVNS     R2,#+1
        LDR.N    R4,??DataTable12_34  ;; 0x400b8080
        STR      R2,[R4, #+0]
//  953   FTM2_FILTER = 0x00;                      //关过虑器
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_35  ;; 0x400b8078
        STR      R2,[R4, #+0]
//  954  
//  955   FTM_CnSC_REG(FTM2_BASE_PTR, channel) = 0x00;
        MOVS     R2,#+0
        LDR.N    R4,??DataTable12_19  ;; 0x400b800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        STR      R2,[R4, R0, LSL #+3]
//  956   FTM_CnSC_REG(FTM2_BASE_PTR, channel) &= (~FTM_CnSC_CHF_MASK);
        LDR.N    R2,??DataTable12_19  ;; 0x400b800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR      R2,[R2, R0, LSL #+3]
        BICS     R2,R2,#0x80
        LDR.N    R4,??DataTable12_19  ;; 0x400b800c
...
//  962     FTM_CnSC_REG(FTM2_BASE_PTR, channel) &= (~FTM_CnSC_ELSB_MASK);  
        LDR.N    R1,??DataTable12_19  ;; 0x400b800c
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR      R1,[R1, R0, LSL #+3]
        BICS     R1,R1,#0x8
        LDR.N    R2,??DataTable12_19  ;; 0x400b800c
...
// 1001   uint8 ftm_ch = FTM_VECTORNUM - 78;
        LDR.N    R0,??DataTable12_36  ;; 0xe000ed04
        LDRB     R0,[R0, #+0]
        SUBS     R0,R0,#+78
// 1002     
// 1003   //调用用户自定义中断服务
